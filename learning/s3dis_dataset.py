...
def get_datasets(args, test_seed_offset=0,aug_type='nn'):
    ...
    tlist = tnt.dataset.ListDataset([spg.spg_to_igraph(*tlist) for tlist in trainlist],functools.partial(spg.loader, train=True, args=args, db_path=args.S3DIS_PATH))
    augl1,augl2 = aug.aug_double(t)
